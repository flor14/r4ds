...
```{r shapes, echo = FALSE, out.width = "75%", fig.asp = 1/3, fig.cap="R tiene 25 formas de default que están identificadas por números. .", warning = FALSE}
...
```{r}
ggplot(data = diamantes) + 
  stat_count(mapping = aes(x = cortes))
```
